...
<div class="container">
    ...
    <div class="navbar-collapse-header">
        ...
        <div class="col-6 collapse-brand">
            ...
            <img src="<?=base_url() ?>template/assets/img/brand/blue.png">
            </a>
        </div>
    ...
    <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        <li class="nav-item">
        <a class="nav-link nav-link-icon" href="https://www.facebook.com/creativetim" target="_blank" data-toggle="tooltip" data-original-title="Síguenos en Facebook">
        ...
        <li class="nav-item">
        <a class="nav-link nav-link-icon" href="https://twitter.com/creativetim" target="_blank" data-toggle="tooltip" data-original-title="Siguenos en Twitter">
