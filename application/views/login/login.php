        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Gestione sus finanzas fácilmente con <br>Household Your Money.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><small>O inicie sesión con</small></div>
              <div class="btn-wrapper text-center">
                <!--<a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="<?=base_url() ?>template/assets/img/icons/common/github.svg"></span>
                  <span class="btn-inner--text">Github</span>
                </a>-->
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="<?=base_url() ?>template/assets/img/icons/common/google.svg"></span>
