                    ...
                    <div class="widget widget-account-invoice-three">
                        ...
                        <div class="widget-heading">
                            <div class="wallet-usr-info">
                                <div class="usr-name">
                                    <span><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="admin-profile" class="img-fluid"> Alan Green</span>
                                </div>
                                <div class="add">
                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Luke Ivory</span></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Andy King</span></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Laurie Fox</span></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Ryan Collins</span></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Irene Collins</span></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content customer-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="avatar"><span>Sonia Shaw</span></div></td>
                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table table-scroll">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><div class="td-content product-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Headphone</p><p class="prd-category text-primary">Digital</p></div></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content product-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Shoes</p><p class="prd-category text-warning">Faishon</p></div></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content product-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Watch</p><p class="prd-category text-danger">Accessories</p></div></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content product-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Laptop</p><p class="prd-category text-primary">Digital</p></div></div></td>
                                        ...
                                        <tr>
                                            <td><div class="td-content product-name"><img src="<?=base_url() ?>template/assets/img/90x90.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Camera</p><p class="prd-category text-primary">Digital</p></div></div></td>
